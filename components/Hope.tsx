      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="block lg:hidden">
          <motion.div
            ...
            className="mb-6"
          >
            <p className="text-sm font-bold text-gray-900 mb-1">Hope</p>
            <h2 className="text-3xl font-sora font-bold leading-tight text-black mb-4">
              Your next opportunity starts with preparation
            </h2>
          ...
          <div className="flex flex-col gap-4 mb-10">
            {cards.map((card, idx) => (
              ...
              >
                <div
                  className={`shrink-0 w-16 h-18 rounded-xl ${card.bg} flex items-center justify-center`}
                >
                  {card.icon}
                </div>
                <div>
