      ...
      >
        ...
        <div className="block lg:hidden">
          ...
          <div className="mb-8 text-left">
            <span className="text-sm font-bold text-[#0C0801]">
              Our Services
            </span>
            <h2
              className="mt-2 text-[32px] font-sora font-bold leading-tight text-black"
              style={{ fontFamily: "var(--font-sora)" }}
            >
              How we support your career
            </h2>
          ...
          <div className="flex flex-col gap-5">
            {/* CARD 1 - Free CV Review (Image Left, Text Right) */}
            <motion.div
              className="bg-white border rounded-[20px] p-3 shadow-sm flex items-center gap-4"
              style={{ borderColor: "#FFBD43" }}
              whileTap={{ scale: 0.98 }}
            >
              {/* Image Left */}
              <div className="relative w-[40%] shrink-0 aspect-[4/3] rounded-xl overflow-hidden">
                <Image
                  src="/service1.png"
                  alt="CV Review"
                  fill
              ...
              <div className="w-[60%]">
                <h3
                  className="text-[18px] font-bold text-black leading-tight mb-2"
                  style={{ fontFamily: "var(--font-sora)" }}
                >
                  <span className="text-[#FFBD43]">Free</span> CV review
                </h3>
            ...
            {/* CARD 2 - Mock Interviews (Text Left, Image Right) */}
            <motion.div
              className="bg-white border rounded-[20px] p-3 shadow-sm flex items-center gap-4"
              style={{ borderColor: "#917FFE" }}
              whileTap={{ scale: 0.98 }}
            >
              {/* Text Left */}
              <div className="w-[60%]">
                ...
                <p className="text-[11px] text-gray-800 leading-relaxed">
                  Practice real interview questions with industry experts.
                  Book a one-on-one mock interview via WhatsApp and gain
                  confidence with expert feedback.
                </p>
              </div>
